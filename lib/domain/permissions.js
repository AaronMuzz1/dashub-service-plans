...
export function canReverseClaim(actor, plan) {
  return Boolean(plan?.contract && (isDashubAdmin(actor) ||
    (actor?.role === "manager" && actor.dealerGroupId && actor.dealerGroupId === plan.dealerGroupId)));
}
